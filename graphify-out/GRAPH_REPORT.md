...
## Corpus Check
- 10 files · ~51,063 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 329 nodes · 374 edges · 53 communities (28 shown, 25 thin omitted)
...
- [[_COMMUNITY_Header Responsive E2E Spec|Header Responsive E2E Spec]]
...
2. `scripts` - 9 edges
3. `mk()` - 9 edges
4. `Gradvera marketing website` - 9 edges
5. `Locale` - 9 edges
6. `buildHero()` - 8 edges
...
Cohesion: 0.06
Nodes (19): string, t, ../../components/pages/HomeSections.astro, t, m1sFrom, m1sTo, { pct }, t (+11 more)
...
Cohesion: 0.08
Nodes (28): Analytics & Consent (GTM + Consent Mode), astro check Verification Gate, Astro 5 Static Stack, CI & Deploy Flow (Vercel + ci.yml), Design Source of Truth (Claude Design + design-sync), Gradvera Marketing Website, Trilingual i18n Routing, Lead Capture (/api/lead) (+20 more)
...
Cohesion: 0.10
Nodes (24): Analytics.astro component, /api/lead lead-capture endpoint, Astro 5 framework, Google Consent Mode v2, CookieConsent banner, DemoForm.astro demo/contact form, Environment variables, Gradvera marketing website (+16 more)
...
## Knowledge Gaps
- **128 isolated node(s):** `name`, `type`, `version`, `private`, `description` (+123 more)
...
- **Why does `Gradvera marketing website` connect `Brand & Analytics Conventions` to `Brand & Analytics Conventions`?**
