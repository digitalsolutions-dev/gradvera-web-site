...
- **gtm-toolkit v2** — ✅ merged (gtm-toolkit PR #145, 2026-08-20): `WebsiteLead` v2 fields + Topic score suffix + description block (see `docs/lead-integration.md` §2 "Receiver compatibility"). Remaining: deploy the updated receiver image.
