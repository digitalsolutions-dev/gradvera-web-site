...
| 5 | Illustrative product-UI reproductions present on the LP | website | ✅ | PR #82: `ProductEvidence` renders four coded app-window reproductions (the four workflow steps), reusing the homepage `winbar app`/`gv-screen` pattern; honestly framed as illustrations (caption prefix "Illustration ·", not screenshots). Model amended to v1.2 (§7.2.6/§7.3/§19) | 2026-08-21 · Claude (controller) |
...
| LP product-UI reproductions | #82 | 2026-08-21 | `ProductEvidence` → 4 coded app-window reproductions (was screenshots); model v1.2; honesty-framed |
